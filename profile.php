...
<body class="bg-light">
    ...
    $u_exit = select("SELECT * FROM `user_cred` WHERE `id` = ? LIMIT 1", [$_SESSION['uId']], 's');
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 mb-5 px-4">
                <div class="bg-white p-3 p-md-4 rounded shadow-sm">
                    <form id="info-form">
                        ...
                        <button type="submit" class="btn text-white custom-bg shadow-none">Save Chnages</button>
                    </form>
                </div>
            </div>
            ...
            <div class="col-8 mb-5 px-4">
                <div class="bg-white p-3 p-md-4 rounded shadow-sm">
                    <form id="pass-form">
                        <h5 class="mb-3">Changes Password</h5>
    ...
    <script>
        ...
        pass_form.addEventListener('submit', function(e) {
            e.preventDefault();
            $new_pass = pass_form.elements['new_pass'].value;
            $confirm_pass = pass_form.elements['confirm_pass'].value;
